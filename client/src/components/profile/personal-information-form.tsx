...
const PersonalInformationForm = ({ defaultValues }: Props) => {
  ...
  const renderEmailVerificationBanner = () => (
    <div className="flex flex-col justify-between gap-3 px-4 py-3 sm:flex-row sm:items-center">
      <div className="flex min-w-0 items-center gap-2">
        {isEmailVerified ? (
          <CheckCircleIcon className="text-success h-5 w-5 shrink-0" />
        ) : (
          <ExclamationCircleIcon className="text-warning h-5 w-5 shrink-0" />
        )}
  ...
  const renderProfilePictureInput = () => (
    <Card className="flex min-h-[88px] flex-col gap-0 border p-0 md:col-span-2">
