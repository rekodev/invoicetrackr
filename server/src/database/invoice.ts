...
export const getInvoicesFromDb = async (userId: number) => {
  const invoices = await sql`
    select
      ...
      users.signature as sender_signature,
      users.profile_picture_url as sender_profile_picture_url,
      users.language as sender_language, 
      users.currency as sender_currency,
