...
import { localizeInvoiceUnit } from './units';
import {
...
export default function PDFDocument({
  ...
  const lineTotalColumnStyle = shouldShowVatDetails
    ? pdfStyles.tableCol7
    : { ...pdfStyles.tableCol7, width: '25%' as const };
  ...
  const renderTableRow = (
    ...
    description: string,
    unit: string,
    quantity: InvoiceServiceBody['quantity'],
    amount: InvoiceServiceBody['amount'],
    vatRate?: InvoiceServiceBody['vatRate'],
